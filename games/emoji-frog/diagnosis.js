    ...
    show(stats) {
        ...
        const html = `
            <div id="diagnosisModal" style="position:fixed;top:0;left:0;width:100%;height:100%;background:rgba(0,0,0,0.92);z-index:99999;overflow-y:auto;-webkit-overflow-scrolling:touch;padding:20px 0;box-sizing:border-box;touch-action:pan-y!important;"
                 onclick="FrogDiagnosis.hide()">
                <div style="background:linear-gradient(135deg,#0d1f15 0%,#1a3a2e 100%);border-radius:20px;padding:30px;max-width:420px;width:90%;border:2px solid rgba(74,222,128,0.3);position:relative;margin:auto;touch-action:pan-y!important;"
