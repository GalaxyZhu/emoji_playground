    ...
    show(stats) {
        ...
        const html = `
            <div id="diagnosisModal" style="position:fixed;top:0;left:0;width:100%;height:100%;background:rgba(0,0,0,0.92);z-index:99999;overflow-y:auto;-webkit-overflow-scrolling:touch;padding:20px 0;box-sizing:border-box;touch-action:pan-y!important;"
                 onclick="RollingDiagnosis.hide()">
                <div style="background:linear-gradient(135deg,#2d1f1f 0%,#1a1a1a 100%);border-radius:20px;padding:30px;max-width:420px;width:90%;border:2px solid rgba(255,100,0,0.3);position:relative;margin:auto;touch-action:pan-y!important;"
